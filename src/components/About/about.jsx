    ...
    <section className="about">
      ...
      <article className="about-main-container">
        ...
        >
          ...
          <p>
            Soy <b>Lucas Garcia Diaz</b>, actualmente estoy estudiando un{" "}
            <b>Grado Superior</b> de Desarrollo de Aplicaciones Web, soy un
            apasionado al desarrollo web.
          </p>
          <p>
            Soy una persona en constante aprendizaje,<b> autodidacta,</b> la
            cual invierte mucho tiempo en mejorarse día a día y lograr sus{" "}
            <b>objetivos</b>, también muy <b>deportista</b> y <b>exigente</b> en
            todo lo que hace. Espero que disfruten.
          </p>
          <p>
            <b>Estoy abierto a cualquier oferta.</b>
          </p>
        </motion.div>
        <motion.div
